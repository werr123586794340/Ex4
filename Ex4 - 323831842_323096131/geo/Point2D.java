...
public class Point2D{
	...
	// this function moves the Point by given vector
	public void move(Point2D vec) {
		this._x += vec.x();
		this._y += vec.y();
	}

	// this function scales the point with respect to the given center point
	...
	// this function rotates the point with respect to the given center point by an angle
